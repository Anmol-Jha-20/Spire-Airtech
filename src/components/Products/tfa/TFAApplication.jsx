...
import TFAApplicationImage from "../../../assets/ApplicationImageOne.png";

const TFAApplication = () => {
  const applications = [
        ...
        <div className="max-w-4xl ml-6">
          ...
          <motion.div className="mb-12" variants={fadeInVariants}>
            <h3 className="text-xl md:text-2xl text-gray-600 mb-8 font-medium">
              "Enhance IAQ & Cut Energy Costs — All in One Unit "
            </h3>
            ...
            <motion.p
              ...
              variants={fadeInVariants}
            >
              Bring sustainable ventilation to your building with our PHE-based
              TFA Unit. Designed for maximum efficiency, hygiene, and
              flexibility.
            </motion.p>
          </motion.div>
