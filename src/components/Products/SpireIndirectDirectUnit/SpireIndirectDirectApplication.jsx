...
import SingleStageApplicationImage from "../../../assets/ApplicationImageFour.png";

const SpireIndirectDirectApplication = () => {
  const applications = [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div className="lg:pl-8" variants={itemVariants}>
              <div className="relative overflow-hidden rounded-lg shadow-xl">
                ...
                >
                  <img
                    src={SingleStageApplicationImage}
                    className="w-full"
                    alt="Single Stage Application Image"
                  />
                </motion.div>
              </div>
            </motion.div>
        ...
        <div className="max-w-4xl ml-6">
          ...
          <motion.div className="mb-12" variants={fadeInVariants}>
            <h3 className="text-xl md:text-2xl text-gray-600 mb-8 font-medium">
              "Cool Naturally. Save Consistently. Perform Reliably."
            </h3>
            ...
            <motion.p
              ...
              variants={fadeInVariants}
            >
              Upgrade to the energy-efficient cooling solution your facility
              deserves. Our Single Stage Air Washer ensures comfort, hygiene,
              and sustainability.
            </motion.p>
          </motion.div>
...
export default SpireIndirectDirectApplication;
