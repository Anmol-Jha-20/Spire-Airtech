...
import CleanroomAHUApplicationImage from "../../../assets/ApplicationImageFour.png";

const CeilingSuspendedApplication = () => {
  const applications = [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div className="lg:pl-8" variants={itemVariants}>
              <div className="relative overflow-hidden rounded-lg shadow-xl">
                ...
                >
                  <img
                    src={CleanroomAHUApplicationImage}
                    className="w-full"
...
export default CeilingSuspendedApplication;
